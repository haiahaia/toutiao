  ...
  <div class="user-container">
    ...
    <div class="user-card">
      ...
      <van-cell>
        <!-- 使用 title 插槽来自定义标题 -->
        <template #icon>
          <img :src="userData.photo" alt="" class="avatar">
        </template>
        <template #title>
    ...
    <van-cell-group class="action-card">
      ...
      <van-cell icon="warning-o" title="退出登录" is-link @click="unload"/>
    </van-cell-group>
  </div>
</template>
...
import { userProfileAPI, grtUserInfo } from '@/api'
...
export default {
  ...
  async created () {
    ...
    const ref2 = await grtUserInfo()
    this.user = ref2.data.data
